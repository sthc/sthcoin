...
* sthcoin.conf: contains configuration settings for sthcoind or sthcoin-qt
* sthcoind.pid: stores the process id of sthcoind while running
...
* debug.log: contains debug information and general logging generated by sthcoind or sthcoin-qt
