...
This document provides guidelines for internationalization of the Sthcoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `sthcoin_en.ts` remains unchanged.
