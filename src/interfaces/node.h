...
#ifndef STHCOIN_INTERFACES_NODE_H
#define STHCOIN_INTERFACES_NODE_H
...
//! Top-level interface for a sthcoin node (sthcoind process).
class Node
{
public:
    virtual ~Node() {}
...
#endif // STHCOIN_INTERFACES_NODE_H
