...
#ifndef STHCOIN_WALLET_WALLET_H
#define STHCOIN_WALLET_WALLET_H
...
//! -paytxfee default
constexpr CAmount DEFAULT_PAY_TX_FEE = 20; // 0;
//! -fallbackfee default
static const CAmount DEFAULT_FALLBACK_FEE = 20; // 20000;
//! -discardfee default
static const CAmount DEFAULT_DISCARD_FEE = 20; // 10000;
//! -mintxfee default
static const CAmount DEFAULT_TRANSACTION_MINFEE = 10; // 1000;
//! minimum recommended increment for BIP 125 replacement txs
static const CAmount WALLET_INCREMENTAL_RELAY_FEE = 10; // 5000; // Should be no less than DEFAULT_INCREMENTAL_RELAY_FEE  in policy.h
...
public:
     ...
     * on this sthcoin node, and set to 0 for transactions that were created
