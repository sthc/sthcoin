 ...
 */
#ifndef STHCOIN_UTIL_H
#define STHCOIN_UTIL_H
...
extern const char * const STHCOIN_CONF_FILENAME;
extern const char * const STHCOIN_PID_FILENAME;
...
{
    std::string s = strprintf("sthcoin-%s", name);
