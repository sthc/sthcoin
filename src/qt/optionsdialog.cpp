    ...
    mapper(0)
{
    ...
    ui->sthcoinAtStartup->setToolTip(ui->sthcoinAtStartup->toolTip().arg(tr(PACKAGE_NAME)));
    ui->sthcoinAtStartup->setText(ui->sthcoinAtStartup->text().arg(tr(PACKAGE_NAME)));

    ui->openSthcoinConfButton->setToolTip(ui->openSthcoinConfButton->toolTip().arg(tr(PACKAGE_NAME)));
    ...
    ui->unit->setModel(new SthcoinUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->sthcoinAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openSthcoinConfButton_clicked()
{
