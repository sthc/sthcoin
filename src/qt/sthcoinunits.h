...
#ifndef STHCOIN_QT_STHCOINUNITS_H
#define STHCOIN_QT_STHCOINUNITS_H
...
/** Sthcoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class SthcoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit SthcoinUnits(QObject *parent);

    /** Sthcoin units.
      @note Source: https://en.sthcoin.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        STHC,
...
typedef SthcoinUnits::Unit SthcoinUnit;

#endif // STHCOIN_QT_STHCOINUNITS_H
