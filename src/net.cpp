...
void CNode::copyStats(CNodeStats &stats)
{
    ...
    // Raw ping time is in microseconds, but show it to user as whole seconds (Sthcoin users should be well used to small numbers with many decimal places by now :)
...
static void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        std::string strDesc = "Sthcoin " + FormatFullVersion();
...
bool CConnman::OutboundTargetReached(bool historicalBlockServingLimit)
{
    ...
    if (historicalBlockServingLimit)
    {
        ...
        uint64_t buffer = timeLeftInCycle / 120 * MAX_BLOCK_SERIALIZED_SIZE; // timeLeftInCycle / 600 * MAX_BLOCK_SERIALIZED_SIZE; // & 
