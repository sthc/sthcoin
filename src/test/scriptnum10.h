...
#ifndef STHCOIN_TEST_SCRIPTNUM10_H
#define STHCOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Sthcoin Core 0.10.0, for cross-comparison.
 */
public:
