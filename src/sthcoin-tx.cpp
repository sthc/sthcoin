...
static void SetupSthcoinTxArgs()
{
...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " sthcoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  sthcoin-tx [options] <hex-tx> [commands]  Update hex-encoded sthcoin transaction\n" +
            "or:     sthcoin-tx [options] -create [commands]   Create hex-encoded sthcoin transaction\n" +
            "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded sthcoin transaction
