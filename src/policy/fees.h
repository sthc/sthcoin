...
#ifndef STHCOIN_POLICY_FEES_H
#define STHCOIN_POLICY_FEES_H
...
private:
     ...
     */
    static constexpr double MIN_BUCKET_FEERATE = 10; // 1000; // & 
    static constexpr double MAX_BUCKET_FEERATE = 1e5; // 1e7; // & 
...
{
private:
    static constexpr double MAX_FILTER_FEERATE = 100; // 1e7; // & 
