...
"""Verify that starting sthcoin with -h works as expected."""

from test_framework.test_framework import SthcoinTestFramework
from test_framework.util import assert_equal

class HelpTest(SthcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start sthcoin with -h for help text")
        ...
        self.log.info("Start sthcoin with -version for version information")
        ...
        self.log.info("Start sthcoind with -fakearg to make sure it does not start")
