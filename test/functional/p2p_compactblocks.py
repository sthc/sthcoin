...
# TestP2PConn: A peer we use to send messages to sthcoind, and store responses.
...
class CompactBlocksTest(SthcoinTestFramework):
    ...
    # This test actually causes sthcoind to (reasonably!) disconnect us, so do this last.
    ...
    # Test that sthcoind requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for sthcoind to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # sthcoind will not send blocktxn responses for blocks whose height is
